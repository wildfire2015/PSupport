...
class VolundMultiStandardShaderGUI1 : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static readonly string[] cullingNames = Enum.GetNames (typeof (UnityEngine.Rendering.CullMode));
			...
			//public static GUIContent RimRationText = new GUIContent("Rim Ratio");
			//public static GUIContent RimRangeText = new GUIContent("Rim Range");
			//public static GUIContent RimColorText = new GUIContent("Rim Color");
	}
	...
	MaterialProperty specularMapColorTweak = null;
		MaterialProperty SpecularRegionTweaks = null;
	...
	MaterialProperty emissionColorForRendering = null;
        //MaterialProperty RimColorForRendering = null;
		//MaterialProperty RimRatio = null;
	...
	MaterialProperty smoothnessInAlbedo = null;
		//MaterialProperty enableChangeColor = null;
		//MaterialProperty curveValueAndBrite = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		specularMapColorTweak = FindProperty ("_SpecularMapColorTweak", props, false);
			SpecularRegionTweaks = FindProperty("_SpecularRegion", props, false);            
		...
		emissionColorForRendering = FindProperty ("_EmissionColor", props);
            //RimColorForRendering = FindProperty("_RimColor", props);
			//RimRatio = FindProperty("_RimRatio", props);
		...
		smoothnessInAlbedo = FindProperty ("_SmoothnessInAlbedo", props, false);
			...
			//enableChangeColor = FindProperty("_EnableChangeColor", props, false);
			//curveValueAndBrite = FindProperty("_CurveValueAndBrite", props, false);
			//changeColor = FindProperty ("_ChangeColor", props, false);
	}
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			m_MaterialEditor.ShaderProperty(uvSetSecondary, Styles.uvSetLabel.text);
				//m_MaterialEditor.ShaderProperty(RimRatio, Styles.RimRationText.text );
				//m_MaterialEditor.ShaderProperty(RimRange, Styles.RimRangeText.text );
				//m_MaterialEditor.ShaderProperty(RimColor, Styles.RimColorText.text );

				//m_MaterialEditor.ShaderProperty( enableChangeColor, new GUIContent("enableChangeColor").text);
				//m_MaterialEditor.ShaderProperty (changeColor, new GUIContent("changeColor").text);
				//m_MaterialEditor.ShaderProperty (curveValueAndBrite, new GUIContent("curveValueAndBrite").text);
	...
	void DoSpecularMetallicArea()
	{
		if (m_WorkflowMode == WorkflowMode.Specular)
		{
			if (specularMap.textureValue == null) {
				...
				if(SpecularRegionTweaks != null)
					m_MaterialEditor.ShaderProperty(SpecularRegionTweaks, SpecularRegionTweaks.displayName);
				}
			}
		}
    ...
    static bool ShouldRimLightEnabled(Color color)
    {
        return color.maxColorComponent > (100.0f / 255.0f);
    }
	...
	static void SetMaterialKeywords(Material material, WorkflowMode workflowMode)
	{
		...
		SetKeyword (material, "_EMISSION", shouldEmissionBeEnabled);
			...
			//bool shouldChangeColor = material.GetFloat("_EnableChangeColor") != 1.0 ? false : true;
			//SetKeyword(material, "CHANGECOLOR", shouldChangeColor);

        //bool shouldRimLightEnabled = ShouldRimLightEnabled(material.GetColor("_RimColor"));
       // SetKeyword (material, "_RoleRimEffect", shouldRimLightEnabled);
